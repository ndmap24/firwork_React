...
import TreasurePack from '../assets/images/interstellar-page/treasured-pack.png';
...
function InterstellarTrader({boughtPacksa,clicked, cards, paid, onPage, openPack,ableToOpenPack,redirected }) {

    boughtPacksa()
    useEffect(() => {
        onPage({ pageName: "sparkTreasured", image: "/static/media/treasured-pack.9f5087e9.png" })
        paid()
        clicked()
        redirected()
    })
                        ...
                        <Col xs="12" md="7">
                            <div className="instrelr_left">
                                <ul className="list-inline instrelr_tp_heading">
                                    ...
                                    <li className="list-inline-item">
                                        <h5 className="mb-0 package_heading">Spark Treasured Pack</h5>
                                    </li>
                                    <li className="list-inline-item">
                                ...
                                <div className="open_buy_grp">
                                    <button to="/open_package" className={cards ? "open_buy_grp_btn open_btn " : "open_buy_grp_btn open_btn gray_filter"} onClick={onClick} disabled={!cards}>
...
const mapStateToprops = state => ({
    cards: state.packs.baughtPacks.sparkTreasuerPacks,
    ableToOpenPack : state.packs.ableToOpenPack
})
export default connect(mapStateToprops, {boughtPacksa, clicked,paid, onPage, openPack,redirected })(InterstellarTrader)