...
import { paid } from "../actions/packs1";

import { connect } from "react-redux";
import { PropTypes } from "prop-types";
import { clicked,onPage,openPack,redirected } from "../actions/packs1";
import { boughtPacksa } from "../actions/selectPack";
function InterstellarTrader({boughtPacksa,clicked,ableToOpenPack, cards, paid,onPage,openPack,redirected }) {
    ...
    useEffect(() => {
        paid()
        onPage({ pageName: "sparkCamp",image : "/static/media/package_grey.f8534de5.png" })
        clicked()
        redirected()
...
const mapStateToprops = (state) => ({
    cards: state.packs.baughtPacks.sparkCampPacks,
